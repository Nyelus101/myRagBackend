...
# -------------------- LLM --------------------
# Global Groq LLM Initialization
...
**Do not use phrases like 'Based on the provided context' or similar qualifiers.**
If the context does not contain the answer, state: "The required information is not available in the documents."
...
def get_general_llm_chain():
    """Returns a simple general-purpose chain for free-form questions"""
    return (
        RunnablePassthrough()
        | GENERAL_PROMPT
        | LLM
...
def get_llm_chain(vectorstore):
    """Returns a RAG chain using a LangChain-Pinecone vectorstore"""
